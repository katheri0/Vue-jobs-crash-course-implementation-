...
<template>
  <backButton />
  <section v-if="!state.isLoadong" class="bg-blue-50">
      ...
      <div class="grid grid-cols-1 md:grid-cols-70/30 w-full gap-6">
        ...
        <aside>
          ...
          <div class="bg-white p-6 rounded-lg shadow-md">
            ...
            <p class="my-2 bg-blue-100 p-2 font-bold"> {{ state.company.contact_phone }} </p>
          </div>

          <!-- Manage -->
          <div class="bg-white p-6 rounded-lg shadow-md mt-6" v-if="authStore.canPostJob">
            <h3 class="text-xl font-bold mb-6">Manage Job</h3>
            <RouterLink :to="`/edit/${state.job.id}`"
